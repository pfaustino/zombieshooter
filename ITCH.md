...
- **Wave survival** — enemies keep coming; clear one wave, the next gets worse
...
- **WebGPU browser** — Chrome 113+ or Edge 113+ (Firefox WebGPU may work depending on flags)
...
Built as a WebGPU port of [3dfps](https://github.com/pfaustino/3dfps), using the Particle Realms engine stack. Early build — feedback welcome.
